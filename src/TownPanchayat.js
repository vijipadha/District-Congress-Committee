...
function TownPanchayat() {
  ...
  return (
    <div className="block">
      <h2>Town Panchayat Committee Form</h2>
      <form onSubmit={handleSubmit} className='block-page'>
        ...
        {/* Name of the TownPanchayat */}
        <div className='dcc-form'>
          <label htmlFor="name">Name of the TownPanchayat:</label>
          <input
            type="text"
            id="nametownpanchayat"
            name="nametownpanchayat"
            value={formData.nametownpanchayat}
            onChange={handleChange}
            required
          />
        </div>
